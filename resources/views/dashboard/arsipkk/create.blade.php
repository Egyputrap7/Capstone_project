        ...
        <div class="row">
            <div class="col-md-9 mx-auto">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">Buat Surat Permohonan Kartu Keluarga</h6>
                    @if (session('success'))
                        <div class="alert alert-success">
                            {{ session('success') }}
                        </div>
                    @endif
                    <form method="post" action="/dashboard/arsipkk/create">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-sm btn-primary">Buat Surat</button>
                    </form>
                </div>
            </div>
        </div>
