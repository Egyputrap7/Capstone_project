        ...
        <div class="row">
            <div class="col-md-9 mx-auto">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">Edit Data Arsip Permohonan KK</h6>
                    <form method="post" action="/dashboard/arsipkk/{{ $akk->id }}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <div class="mb-3">
                            <label for="id" class="form-label">Nomor Surat</label>
                            <input type="number" class="form-control @error('id') is-invalid @enderror"
                                id="id" name="id" autofocus value="{{ old('id', $akk->id) }}" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama Lengkap</label>
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                name="nama" placeholder="Nama Lengkap" required value="{{ old('nama', $akk->nama) }}">
                            @error('nama')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('noKK') is-invalid @enderror" id="noKK"
                                name="noKK" placeholder="Nomor KK" required value="{{ old('noKK', $akk->noKK) }}">
                            @error('noKK')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('nik') is-invalid @enderror" id="nik"
                                name="nik" required value="{{ old('nik', $akk->nik) }}">
                            @error('nik')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" style="height: 150px;" required>{{ old('alamat', $akk->alamat) }}</textarea>
                            @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('RT') is-invalid @enderror" id="RT"
                                name="RT" required value="{{ old('RT', $akk->RT) }}">
                            @error('RT')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('RW') is-invalid @enderror" id="RW"
                                name="RW" required value="{{ old('RW', $akk->RW) }}">
                            @error('RW')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('kodePos') is-invalid @enderror" id="kodePos"
                                name="kodePos" required value="{{ old('kodePos', $akk->kodePos) }}">
                            @error('kodePos')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="date" class="form-control @error('tglSurat') is-invalid @enderror"
                                    id="tglSurat" name="tglSurat" required value="{{ old('tglSurat', $akk->tglSurat) }}">
                                @error('tglSurat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('Camat') is-invalid @enderror"
                                    id="Camat" name="Camat" required value="{{ old('Camat', $akk->Camat) }}">
                                @error('Camat')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('lurah') is-invalid @enderror"
                                    id="lurah" name="lurah" required value="{{ old('lurah', $akk->lurah) }}">
                                @error('lurah')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
