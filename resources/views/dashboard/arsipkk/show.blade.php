            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <a href="/dashboard/arsipkk" class="btn btn-success"><i class="bi bi-arrow-left-square"></i> Kembali</a>
                        <a href="/dashboard/arsipkk/{{ $akk->id }}/cetak" class="btn btn-secondary"><i class="bi bi-printer"></i> Cetak</a>
                    </div>
                    <center style="margin-top: 50px;">
                        ...
                        <table width="545">
                            ...
                            <tr>
                            <td style="text-align: center">Nomor : {{ $akk->id }}/{{ $akk->id }}/2024</td>
                            </tr>
                        </table>
                        <br /><br /><br />
                        <table width="545">
                        ...
                        <table width="545">
                            ...
                            <td width="10">:</td>
                            <td width="335">{{ $akk->nama }}</td>
                            </tr>
                            <tr>
                            <td width="200">No. KK</td>
                            <td width="10">:</td>
                            <td width="335">{{ $akk->noKK }}</td>
                            </tr>
                            <tr>
                            <td width="200">NIK</td>
                            <td width="10">:</td>
                            <td width="335">{{ $akk->nik }}</td>
                            </tr>
                            <tr>
                            <td width="200">Alamat</td>
                            <td width="10">:</td>
                            <td width="335">{{ $akk->alamat }}</td>
                            </tr>
                            <td width="200">RT</td>
                            <td width="10">:</td>
                            <td width="335">{{ $akk->RT }}</td>
                            </tr>
                            </tr>
                            <td width="200">RW</td>
                            <td width="10">:</td>
                            <td width="335">{{ $akk->RW }}</td>
                            </tr>
                            <td width="200">Kode Pos</td>
                            <td width="10">:</td>
                            <td width="335">{{ $akk->kodePos }}</td>
                            </tr>
                        </table>
                        ...
                        <table width="545">
                            <tr>
                                <td width="340"></td>
                                <td style="text-align: left">Yogyakarta, {{ date('d M Y', strtotime($akk->tglSurat)); }}</td>
                            </tr>
                        </table>
                        <table width="650">
                            <tr>
                        ...
                        <table width="650" style="margin-bottom: 100px">
                            <tr>
                                <td width="10"></td>
                                <td style="text-align: left">{{ $akk->Camat }}</td>
                                <td width="240"></td>
                                <td style="text-align: left">{{ $akk->nama }}</td>
                            </tr>
                        </table>
                    </center>
                </div>
