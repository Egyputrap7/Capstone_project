                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="/dashboard/Update" class="dropdown-item {{ Request::is('dashboard/Update*') ? 'active' : '' }}"><i class="bi bi-house"></i>  Profil desa</a>
                    ...
                    <a href="#" class="nav-item nav-link {{ Request::is('dashboard') ? 'active' : '' }}"><i class="bi bi-inbox-fill"></i> feedback</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
